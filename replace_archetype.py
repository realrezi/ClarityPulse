...
with open('/Users/m1/Documents/ClarityPulse/ClarityPulse/Managers/ArchetypeEngine.swift', 'r') as f:
    content = f.read()
...
with open('/Users/m1/Documents/ClarityPulse/ClarityPulse/Managers/ArchetypeEngine.swift', 'w') as f:
    f.write(new_content)
